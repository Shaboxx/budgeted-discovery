...
def report(root: str|Path) -> Path:
    ...
    body=f'''<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width"><title>Budgeted Discovery experiment report</title>
